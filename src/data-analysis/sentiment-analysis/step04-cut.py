...
#参数初始化
inputfile1 = f'{DIR}/data/meidi_jd_neg.txt'
inputfile2 = f'{DIR}/data/meidi_jd_pos.txt'
outputfile1 = f'{DIR}/data/meidi_jd_neg_cut.txt'
outputfile2 = f'{DIR}/data/meidi_jd_pos_cut.txt'
