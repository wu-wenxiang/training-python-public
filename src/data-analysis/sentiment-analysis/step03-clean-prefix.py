...
#参数初始化
inputfile1 = f'{DIR}/data/meidi_jd_process_end_负面情感结果.txt'
inputfile2 = f'{DIR}/data/meidi_jd_process_end_正面情感结果.txt'
outputfile1 = f'{DIR}/data/meidi_jd_neg.txt'
outputfile2 = f'{DIR}/data/meidi_jd_pos.txt'
